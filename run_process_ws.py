...
group_list = pd.read_csv('utils/ws_group.csv')['linkurl'].to_list()
...
if __name__ == "__main__":
    ...
    platformType = 'ws_all'
    start_index = 0
    # run(0, platformType_run=platformType, maxProcesses=1)

    run(start_index, loop_platformType=platformType, maxProcesses=1)
    # group_list = pd.read_csv('utils/ws_group.csv')['linkurl'].to_list()
    # print(group_list)
